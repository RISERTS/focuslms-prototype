...
-- CreateEnum
CREATE TYPE "ActionType" AS ENUM ('LOGIN', 'OPEN_MATERIAL', 'START_QUIZ', 'ANSWER_QUESTION', 'SUBMIT_QUIZ', 'VIEW_DASHBOARD');
...
CREATE TABLE "Question" (
    ...
    "timeThresholdSeconds" INTEGER NOT NULL,
